...
from movies.views import RateView, GenreMovieView, MovieView, MovieDetailView, CommentView, EpisodeMovieView, WishListView, LatestRateView, RankingView , PlayHistoryView
